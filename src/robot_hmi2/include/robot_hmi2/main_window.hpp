/**
 * @file /include/robot_hmi2/main_window.hpp
 *
 * @brief Qt based gui for robot_hmi2.
 *
 * @date November 2010
 **/
#ifndef robot_hmi2_MAIN_WINDOW_H
#define robot_hmi2_MAIN_WINDOW_H
...
#endif // robot_hmi2_MAIN_WINDOW_H
