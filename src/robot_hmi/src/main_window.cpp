...
void MainWindow::ReadSettings() {
    ...
    QString master_url = settings.value("master_url",QString("http://192.168.11.222:11311/")).toString();
    QString host_url = settings.value("host_url", QString("192.168.11.222")).toString();
